...
import { Highlighter, PaintBucket, X, Check, Type } from "lucide-react"
...
// Available highlight colors - expanded list to match rectangle tool
const COLORS = [
  "#FFEB3B", // Yellow
  "#4CAF50", // Green
  "#2196F3", // Blue
...
export default function TextHighlighter({ position, onHighlight, onCancel }: TextHighlighterProps) {
  ...
  return (
    ...
    >
      <div className="p-1 flex items-center gap-1">
        <span className="text-xs font-medium px-2 text-gray-500">Highlight Text</span>
        ...
        >
          <Type size={16} style={{ color: currentColor }} />
        </Button>
